  ...
  return (
    <div className="bg-[#080808]">
      <section className="mx-auto w-full max-w-7xl px-6 pb-[120px] pt-24 md:px-10 md:pt-28">
        <div className="rounded-[36px] border border-[#1a1a1a] bg-[radial-gradient(circle_at_50%_24%,#1a1a2e_0%,#0a0a0a_62%,#0a0a0a_100%)] px-8 py-16 md:px-14 md:py-20">
          ...
          <h1 className="max-w-5xl text-[80px] font-bold leading-[0.98] tracking-[-0.05em] text-white md:text-[108px]">
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pb-[140px] md:px-10">
        <div className="rounded-[28px] bg-gradient-to-r from-[#6366f1] via-[#7c3aed] to-[#9333ea] p-[1px]">
          ...
          <h2 className="max-w-3xl text-4xl font-semibold tracking-[-0.03em] text-white md:text-6xl">
